...
\begin{enumerate}
    \item \textbf{FedAvg with Differential Privacy:} Structural privacy boundedness through gradient clipping and Gaussian noise injection, with explicit ($\epsilon, \delta$)-DP accounting.
