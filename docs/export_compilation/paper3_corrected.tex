...
\begin{table}[htbp]
\caption{Scalability Stress Test (Apple M2) - Classroom-scale deployment assumes zone-based aggregation.}
\begin{center}
\begin{tabular}{ccc}
\toprule
...
\multicolumn{3}{l}{\footnotesize{These measurements reflect single-camera, single-zone tracking}} \\
\multicolumn{3}{l}{\footnotesize{and should not be extrapolated to dense multi-camera fusion scenarios.}}
\end{tabular}
\end{center}
\end{table}
