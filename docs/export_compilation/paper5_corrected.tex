...
\end{tabular}
\end{center}
\textit{*Note: Accuracy loss is relative to the FP32 baseline on the evaluation dataset used for throughput benchmarking. Absolute accuracy is task-dependent. Evaluation dataset is internal and used solely for throughput characterization, not task benchmarking.}
\end{table}
