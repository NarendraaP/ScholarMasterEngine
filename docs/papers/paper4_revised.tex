...
\caption{Confirmation of logic engine raised alert for schedule conflict using synthetic agent data. The evaluation concluded on the discrepancy between the location (Canteen) and the scheduled requirement (Math Class).}
\label{fig:truancy}
\end{figure}
