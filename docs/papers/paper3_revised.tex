...
\caption{The skeletal overlay in Figure 2 shows what level of abstraction is retained by the perception logic. Of importance is that the secure deletion routine is executed right after vectorization. In this way, if the following logic freezes, the raw frames will not be stored in memory.}
\label{fig:skeleton}
\end{figure}
