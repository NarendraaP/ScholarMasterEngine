...
\bibitem{platt1999probabilistic} J. Platt, ``Probabilistic outputs for support vector machines and comparisons to regularized likelihood methods,'' in \emph{Advances in Large Margin Classifiers}, A. J. Smola, P. L. Bartlett, B. Sch\ddot{o}lkopf, and D. Schuurmans, Eds. Cambridge, MA: MIT Press, 1999, pp. 61--74.
