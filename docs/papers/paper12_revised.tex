...
\bibitem{b19} D. Woodhouse, ``JFFS: The Journalling Flash File System,'' in \textit{Proc. Ottawa Linux Symposium}, 2001, pp. 1--12.

\bibitem{b5} R. Bez et al., ``Introduction to Flash Memory,'' \textit{Proceedings of the IEEE}, vol. 91, no. 4, pp. 489--502, 2003.

\bibitem{b15} J. Axboe, ``Linux Block IO: Present and Future,'' in \textit{Proc. Ottawa Linux Symposium}, 2004, pp. 51--61.
