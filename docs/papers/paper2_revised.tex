...
\caption{Console output from the re-weighting engine demonstrating real-time contextual adaptation. A visually negative valence ($V_{neg} = 0.72$) is amplified to an engagement score of 0.81 upon encountering high-density STEM terminology.}
