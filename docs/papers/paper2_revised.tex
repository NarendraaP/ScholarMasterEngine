...
\end{lstlisting}
\caption{Real-time console telemetry illustrating contextual probabilistic re-weighting: A visually negative valence ($V_{neg} = 0.72$) maps to engagement score 0.81 on exposure to high-density STEM terminology.}
