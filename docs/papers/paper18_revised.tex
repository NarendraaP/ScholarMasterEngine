...
\bibitem{b10} J. Chow, B. Pfaff, T. Sugerman, K. Christopher, and M. Rosenblum, ``Understanding data lifetime with taint analysis,'' in \textit{13th USENIX Security Symposium}, 2004, pp. 187--202.

\bibitem{b11} S. A. Seshia, S. Sadigh, and S. S. Sastry, ``Towards verified artificial intelligence,'' \textit{Communications of the ACM}, vol. 65, no. 7, pp. 46--55, 2022.

\bibitem{b12} H. Kopetz, \textit{Real-Time Systems: Design Principles for Distributed Embedded Applications}. Springer, 2011.

\bibitem{b23} T. Garfinkel et al., ``Terra: A flexible architecture for robust trusted computing,'' in \textit{Proceedings of the 19th ACM Symposium on Operating Systems Principles (SOSP)}, 2003, pp. 193--206.
