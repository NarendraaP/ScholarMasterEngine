...
Fault injection testing has a long history in systems research \cite{b1, b2}, formalized through dependability taxonomies \cite{b24} and software fault injection surveys \cite{b18}. Runtime verification approaches \cite{b11, b16} further validate execution behaviors, building upon axiomatic program correctness \cite{b19}, multiprocess verification \cite{b15}, model checking \cite{b14}, and abstract interpretation \cite{b28}. Automated test generation systems like CUTE \cite{b26} and KLEE \cite{b27} enable systematic path exploration. Watchdog-based enforcement is standard in safety-critical systems \cite{b3, b12} and avionics architecture partitioning \cite{b22}. Memory zeroization techniques derive from secure deletion literature \cite{b4} and memory safety analyses \cite{b8, b10}, while fail-closed semantics are established in safety-critical computing \cite{b5} and modern operating systems \cite{b21}. Hardware enclaves such as Intel SGX \cite{b20} and trusted platforms \cite{b23} offer hardware isolation, but cold boot vulnerabilities \cite{b29} necessitate rapid zeroization. In privacy-by-design architectures \cite{b6} and mobile edge computing \cite{b7}, runtime guarantees are further bounded by hardware-level memory envelopes \cite{b25}. Our contribution is applying these techniques specifically to verify privacy-by-architecture claims in edge AI systems.
...
\bibitem{b24} A. Avizienis, J.-C. Laprie, B. Randell, and C. Landwehr, ``Basic concepts and taxonomy of dependable and secure computing,'' \textit{IEEE Transactions on Dependable and Secure Computing}, vol. 1, no. 1, pp. 11--33, 2004.

\bibitem{b11} S. A. Seshia, D. Sadigh, and S. S. Sastry, ``Toward verified artificial intelligence,'' \textit{Communications of the ACM}, vol. 65, no. 7, pp. 46--55, 2022.
...
\bibitem{b28} P. Cousot and R. Cousot, ``Abstract interpretation: A unified lattice model for static analysis of programs by construction or approximation of fixpoints,'' in \textit{Proceedings of the 4th ACM SIGACT-SIGPLAN Symposium on Principles of Programming Languages (POPL)}, 1977, pp. 238--252.

\bibitem{b26} K. Sen, D. Marinov, and G. Agha, ``CUTE: A concolic unit testing engine for C,'' in \textit{Proceedings of the 10th European Software Engineering Conference (ESEC/FSE)}, 2005, pp. 263--272.

\bibitem{b27} C. Cadar, D. Dunbar, and D. Engler, ``KLEE: Unassisted and automatic generation of high-coverage tests for complex systems programs,'' in \textit{8th USENIX Symposium on Operating Systems Design and Implementation (OSDI)}, 2008, pp. 209--224.
...
\bibitem{b12} H. Kopetz, \textit{Real-Time Systems: Design Principles for Distributed Embedded Applications}. Springer, 2011.

\bibitem{b22} J. Rushby, ``Partitioning in avionics architectures: Requirements, mechanisms, and assurance,'' \textit{NASA Contractor Report}, CR-1999-209347, 1999.

\bibitem{b4} P. Gutmann, ``Secure deletion of data from magnetic and solid-state memory,'' \textit{USENIX Security}, 1996.

% Fail-Safe Systems

\bibitem{b8} L. Szekeres, M. Payer, T. Wei, and D. Song, ``SoK: Eternal war in memory,'' in \textit{IEEE Symposium on Security and Privacy (S\&P)}, 2013, pp. 48--62.

\bibitem{b10} J. Chow, B. Pfaff, T. Garfinkel, K. Christopher, and M. Rosenblum, ``Understanding data lifetime via whole system simulation,'' in \textit{Proc. 13th USENIX Security Symposium}, 2004, pp. 321--336.

\bibitem{b5} N. G. Leveson, \textit{Safeware: System Safety and Computers}. Addison-Wesley, 1995.

% Privacy by Design

\bibitem{b20} V. Costan and S. Devadas, ``Intel SGX Explained,'' \textit{IACR Cryptology ePrint Archive}, Report 2016/086, 2016.

\bibitem{b23} T. Garfinkel, B. Pfaff, J. Chow, M. Rosenblum, and D. Boneh, ``Terra: A virtual machine-based platform for trusted computing,'' in \textit{Proc. 19th ACM Symposium on Operating Systems Principles (SOSP)}, 2003, pp. 193--206.

\bibitem{b29} J. A. Halderman et al., ``Lest we remember: Cold-boot attacks on encryption keys,'' \textit{Communications of the ACM}, vol. 52, no. 5, pp. 91--98, 2009.

\bibitem{b6} A. Cavoukian, ``Privacy by design: The 7 foundational principles,'' \textit{Information and Privacy Commissioner of Ontario}, 2009.

\bibitem{b7} Y. Mao, C. You, J. Zhang, K. Huang, and K. B. Letaief, ``A survey on mobile edge computing: The communication perspective,'' \textit{IEEE Communications Surveys \& Tutorials}, vol. 19, no. 4, pp. 2322--2358, 2017.

\bibitem{b25} P. Narendra et al., ``Memory-Bound Edge Efficiency Envelope (MBEEE): A Hardware-Level Analytical Model,'' \textit{Journal for Basic Sciences}, vol. 26, no. 5, pp. 31--37, 2026.
