...
\bibitem{b10} J. Chow et al., ``Understanding data lifetime with taint analysis, in \textit{USENIX Security Symposium}, pp. 187--202, 2004.
\bibitem{b11} S. A. Seshia et al., ``Formal specification and runtime verification for cyber-physical systems, \textit{IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems}, vol. 39, no. 11, pp. 3179--3192, 2020.
