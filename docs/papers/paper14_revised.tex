...
Aggressive Clamping $\gamma = 1.0$ & Terminal Under-fitting & 81.3\% \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\begin{itemize}
    \item \textbf{Communication Latency Dependence:} While polynomial dampening stabilizes delayed gradients, extreme network delays inevitably decelerate global convergence rates.
...
\bibitem{b5} Y. Zhao et al., ``Federated Learning with Non-IID Data,'' \textit{arXiv preprint arXiv:1806.00582}, 2018.
