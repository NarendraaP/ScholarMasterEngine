...
% --- ADDED REFERENCES ---
\bibitem{b_auth_2016} V. Chandrasekar, S. Suresh Kumar, and T. Maheswari, "Authentication based on keystroke dynamics using stochastic diffusion algorithm," \textit{Stochastic Analysis and Applications}, vol. 34, no. 1, pp. 155--164, 2016.
...
\bibitem{b_dexterous_2016} V. Chandrasekar and S. Suresh Kumar, "A Dexterous feature selection Artificial Immune System Algorithm for Keystroke Dynamics," \textit{Stochastic Analysis and Applications}, vol. 34, no. 1, pp. 147--154, 2016.
...
\bibitem{b_wsn_voronoi_2012} S. Nithyakalyani and S. Suresh Kumar, "Energy Efficient Data Aggregation using Voronoi based Genetic Clustering Algorithm in WSN," \textit{International Journal of Computer Applications}, vol. 54, no. 4, 2012.
\bibitem{b_wsn_optimal_2012} S. Nithyakalyani and S. Suresh Kumar, "Optimal Clustering Algorithm for Energy Efficient Data Aggregation in WSN," \textit{European Journal of Scientific Research}, vol. 78, no. 1, pp. 146--155, 2012.
\bibitem{b_keystroke_2011} M. Akila and S. Suresh Kumar, "Improving feature extraction in keystroke dynamics using optimization techniques and neural network," \textit{IET Digital Library}, 2011.
