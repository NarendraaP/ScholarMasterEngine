...
\begin{itemize}[leftmargin=*]
    \item \textbf{Paper 5 (P5)}: \textbf{PUBLISHED} in \textit{Journal for Basic Sciences / IEEE Access} (vol. 26, no. 5, pp. 31--37, 2026).
...
\textit{Journal for Basic Sciences / IEEE Access}, vol. 26, no. 5, pp. 31--37, 2026. DOI: Established.\\
...
\begin{enumerate}
    ...
    \item \textbf{Historical Ground Truth}: Paper 5 (P5) is \textbf{PUBLISHED} (\textit{Journal for Basic Sciences / IEEE Access}, vol. 26, no. 5, pp. 31--37, 2026) and Paper 6 (P6) is \textbf{ACCEPTED / IN PRESS} (\textit{ACM Transactions on Embedded Computing Systems (TECS) / IEEE Sensors Journal}, 2026). Both are legitimately citable prior art by all other papers in the portfolio.
